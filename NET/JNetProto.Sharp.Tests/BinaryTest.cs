...
namespace JNetProto.Sharp.Tests
{
    public class BinaryTest
    {
        ...
        [InlineData("0001010200000001000101", new[] { false, true })]
        // Byte
        [InlineData("0000", (byte)0)]
        [InlineData("007F", (byte)127)]
        [InlineData("00FF", (byte)255)]
        [InlineData("00020102000000020D022A", new byte[] { 13, 42 })]
        // SByte
        ...
        [InlineData("0003010200000003F3032A", new sbyte[] { -13, 42 })]
        // Short
        ...
        [InlineData("0004010200000004F3FF042A00", new short[] { -13, 42 })]
        // Int
        ...
        [InlineData("0005010200000005F3FFFFFF052A000000", new [] { -13, 42 })]
        // Long
        ...
        [InlineData("0006010200000006F3FFFFFFFFFFFFFF062A00000000000000", new long[] { -13, 42 })]
        // Float
        ...
        [InlineData("0007010200000007CDCC54C107CDCC2942", new[] { -13.3f, 42.45f })]
        // Double
        ...
        [InlineData("00080102000000089A99999999992AC0089A99999999394540", new [] { -13.3, 42.45 })]
        // Decimal
        ...
        [InlineData("000901020000000903313333090434323435", "1;13.3m;42.45m")]
        // TimeSpan
        ...
        [InlineData("000C01020000000C000000007C674C410C00000000AA0C6CC1", "1;01:02:03t;-04:05:06t")]
        // DateTime
        ...
        [InlineData("000D01020000000D00D2585C00000000000000000D80C8965C0000000000000000", "1;2019-02-05d;2019-03-24d")]
        // Guid
        ...
        [InlineData("000E01020000000E92BA70EEFF8D7E4CA6C9081BBA58EA020E74BC0781FF1C0549990703601697CEA1", "1;ee70ba92-8dff-4c7e-a6c9-081bba58ea02g;8107bc74-1cff-4905-9907-03601697cea1g")]
        // Char
        [InlineData("002000", ' ')]
        [InlineData("005F00", '_')]
        [InlineData("000A01020000000A20000A5F00", new[] { ' ', '_' })]
        // String
        [InlineData("0000", "")]
        [InlineData("00015F", "_")]
        [InlineData("000B01020000000B000B015F", new[] {  "", "_" })]
